    ...
    <div>
        <div class="flex flex-col w-full pt-6">
            ...
            <div class="container flex flex-wrap mx-auto p-2">
                <div class="w-full p-2 rounded lg:w-1/4 md:w-1/2" v-for="(file, key) in docs" v-if="file.id == null">
                    <!-- <iframe
                        class="w-full"
        ...
        <div class="form-group">
            <div>
                <button class="btn btn-sm btn-primary" type="submit" :disabled="this.docs.length <= 0" @click="uploadDocs">
                    Upload
                </button>
            </div>
        </div>
