            ...
            <div class="card-body">
                ...
                <div class="overflow-x-auto p-2">
                    <table class="table table-compact w-full" id="item-table">
                        ...
                        <tbody>
                            <template v-for="(x, index) in tran_type">
                                <tr>
                                    <td>{{ x.id }}</td>
                                    <td>{{ x.desc }}</td>
                                    <td>{{ x.code }}</td>
...
import ModalInputForm from "./TrantypeAddForm.vue";
export default {
    data() {
        return {
            tran_type: [],
    ...
    methods: {
        tblData(p) {
            ...
            axios
                .get(
                    "/admin/transaction-type-table?page=" +
                        this.tbl.page +
                        "&entries=" +
                        this.tbl.entries +
                        "&search=" +
        ...
        initNewType() {
            document.getElementById("add_type_modal").checked = true;
            // setTimeout(() => {
