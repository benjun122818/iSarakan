...
@section('content')
<div style="font-family: Arial, Arial monospace sans-serif; margin-top: 152px; max-width: 400px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="text-align: left; font-size: 12px; padding-left: 40px; padding-top: 5px;" valign="top">
                    ...
                    <br>
                    <span style="font-size: 9px;">{{ $studentInfo->student_number }} / {{ $student_record->degree->abbr }}</span>
                </td>
                <td style="font-size: 12px; padding-top: 8px;" width="90" valign="top">{{ \Carbon\Carbon::parse(date('Y-m-d'))->format('m/d/Y') }}</td>
            </tr>
        </table>
    </div>
        ...
        <table style="font-size: 9px; position: absolute;" width="380" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="100" style="text-align: right;" valign="top">{{ number_format($payment['amount'], 2, '.', ' ') }}</td>
                </tr>
                @endforeach
            </tbody>
